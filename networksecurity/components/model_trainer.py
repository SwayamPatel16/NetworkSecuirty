...
dagshub.init(repo_owner='SwayamPatel16', repo_name='NetworkSecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, train_metric, test_metric):
        ...
        try:
            ...
            logging.warning(f"MLflow logging failed: {str(e)}")
            pass

    def train_model(self, X_train, y_train, X_test, y_test):
    
        print("----> RUNNING UPDATED train_model CODE <----")
        ...
        model_trainer_artifact = ModelTrainerArtifact(
            trianed_model_file_path=self.model_trainer_config.trained_model_file_path,
